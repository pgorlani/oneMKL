...
#ifndef _TEST_SPSM_HPP__
#define _TEST_SPSM_HPP__
...
void test_helper_with_format(testFunctorI32 test_functor_i32, testFunctorI64 test_functor_i64,
    ...
    // Test index_base 1
    EXPECT_TRUE_OR_FUTURE_SKIP(
        test_functor_i32(dev, queue_properties, format, m, cols, density_A_matrix, oneapi::mkl::index_base::one, col_major,
                         transpose_val, transpose_val, alpha, default_alg, default_A_view, default_properties,
                         no_reset_data, no_scalars_on_device),
        num_passed, num_skipped);
    ...
    EXPECT_TRUE_OR_FUTURE_SKIP(
        test_functor_i32(dev, queue_properties, format, m, cols, density_A_matrix, index_zero, col_major,
                         transpose_val, transpose_val, alpha, default_alg, upper_A_view, default_properties,
                         no_reset_data, no_scalars_on_device),
        num_passed, num_skipped);
    ...
    EXPECT_TRUE_OR_FUTURE_SKIP(
        test_functor_i32(dev, queue_properties, format, m, cols, density_A_matrix, index_zero, col_major,
                         transpose_val, transpose_val, alpha, default_alg, triangular_unit_A_view, default_properties,
                         no_reset_data, no_scalars_on_device),
        num_passed, num_skipped);
...
//    EXPECT_TRUE_OR_FUTURE_SKIP(
//        test_functor_i32(dev, queue_properties, format, m, cols, density_A_matrix, index_zero, col_major,
//                         transpose_val, transpose_val, set_fp_value<fpType>()(2.f, 1.5f), default_alg, default_A_view, default_properties,
//                         no_reset_data, no_scalars_on_device),
//        num_passed, num_skipped);
    // Test int64 indices
    EXPECT_TRUE_OR_FUTURE_SKIP(
        test_functor_i64(dev, queue_properties, format, 32L, 32L, density_A_matrix, index_zero, col_major,
                         transpose_val, transpose_val, alpha, default_alg, default_A_view, default_properties,
                         no_reset_data, no_scalars_on_device),
        num_passed, num_skipped);
    ...
    EXPECT_TRUE_OR_FUTURE_SKIP(
        test_functor_i32(dev, queue_properties, format, m, cols, density_A_matrix, index_zero, col_major,
                         transpose_val, transpose_val, alpha, no_optimize_alg, default_A_view, default_properties,
                         no_reset_data, no_scalars_on_device),
        num_passed, num_skipped);
    // Test upper no_optimize_alg
    EXPECT_TRUE_OR_FUTURE_SKIP(
        test_functor_i32(dev, queue_properties, format, m, cols, density_A_matrix, index_zero, col_major,
                         transpose_val, transpose_val, alpha, no_optimize_alg, upper_A_view, default_properties,
                         no_reset_data, no_scalars_on_device),
        num_passed, num_skipped);
    ...
    for (auto properties : get_all_matrix_properties_combinations(properties_queue, format)) {
      EXPECT_TRUE_OR_FUTURE_SKIP(
          test_functor_i32(dev, queue_properties, format, m, cols, density_A_matrix, index_zero, col_major,
                           transpose_val, transpose_val, alpha, default_alg, default_A_view, properties,
                           no_reset_data, no_scalars_on_device),
          num_passed, num_skipped);
      EXPECT_TRUE_OR_FUTURE_SKIP(
          test_functor_i32(dev, queue_properties, format, m, cols, density_A_matrix, index_zero, col_major,
                           transpose_val, transpose_val, alpha, no_optimize_alg, default_A_view, properties,
                           no_reset_data, no_scalars_on_device),
          num_passed, num_skipped);
    }
    // In-order queue
    EXPECT_TRUE_OR_FUTURE_SKIP(
        test_functor_i32(dev, { sycl::property::queue::in_order{} }, format, m, cols, density_A_matrix, index_zero, col_major,
                         transpose_val, transpose_val, alpha, default_alg, default_A_view, default_properties,
                         no_reset_data, no_scalars_on_device),
        num_passed, num_skipped);
...
/// Compute spsm reference as a dense operation
template <typename fpType, typename intType>
void prepare_reference_spsm_data(sparse_matrix_format_t format, const intType* ia,
