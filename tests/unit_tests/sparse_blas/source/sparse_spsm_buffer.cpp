...
int test_spsm(sycl::device* dev, sycl::property_list queue_properties,
    ...
    try {
        ...
        CALL_RT_OR_CT(oneapi::mkl::sparse::spsm_buffer_size, main_queue, transpose_val, &alpha,
        ...
        CALL_RT_OR_CT(oneapi::mkl::sparse::spsm_optimize, main_queue, transpose_val, &alpha, A_view,
                      A_handle, x_handle, y_handle, alg, descr, workspace_buf);

        CALL_RT_OR_CT(oneapi::mkl::sparse::spsm, main_queue, transpose_val, &alpha, A_view,
        ...
        if (reset_data) {
            ...
            CALL_RT_OR_CT(oneapi::mkl::sparse::spsm_optimize, main_queue, transpose_val, &alpha,
