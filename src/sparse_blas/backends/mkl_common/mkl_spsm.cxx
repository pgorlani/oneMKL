...
void check_valid_spsm(const std::string& function_name, oneapi::mkl::transpose opA,
                      ...
                      dense_matrix_handle_t Y_handle, bool is_alpha_host_accessible, spsm_alg alg) {
...
void spsm_buffer_size(sycl::queue& queue, oneapi::mkl::transpose opA, oneapi::mkl::transpose opX,
    ...
    check_valid_spsm(__func__, opA, opX, A_view, A_handle, X_handle, Y_handle, is_alpha_host_accessible,
                     alg);
    temp_buffer_size = 0;
    spsm_descr->buffer_size_called = true;
}

inline void common_spsm_optimize(sycl::queue& queue, oneapi::mkl::transpose opA,
                                 oneapi::mkl::transpose opX,
                                 const void* alpha,
...
void spsm_optimize(sycl::queue& queue, oneapi::mkl::transpose opA,
                                 oneapi::mkl::transpose opX,
                   const void* alpha,
                   matrix_view A_view, matrix_handle_t A_handle, dense_matrix_handle_t X_handle,
                   dense_matrix_handle_t Y_handle, spsm_alg alg, spsm_descr_t spsm_descr,
    ...
    common_spsm_optimize(queue, opA, opX, alpha, A_view, A_handle, X_handle, Y_handle, alg, spsm_descr);
    if (alg == spsm_alg::no_optimize_alg) {
        return;
    }
...
template <typename T>
sycl::event internal_spsm(sycl::queue& queue, oneapi::mkl::transpose opA,
                                 oneapi::mkl::transpose opX,
                          const void* alpha,
                          matrix_view A_view, matrix_handle_t A_handle,
                          dense_matrix_handle_t X_handle, dense_matrix_handle_t Y_handle,
...
sycl::event spsm(sycl::queue& queue, oneapi::mkl::transpose opA,
                                 oneapi::mkl::transpose opX,
 const void* alpha,
                 matrix_view A_view, matrix_handle_t A_handle, dense_matrix_handle_t X_handle,
                 dense_matrix_handle_t Y_handle, spsm_alg alg, spsm_descr_t spsm_descr,
    ...
    DISPATCH_MKL_OPERATION("spsm", value_type, internal_spsm, queue, opA, opX, alpha, A_view, A_handle,
