...
inline void gebrd(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, m, n, a_, lda, d_, e_, tauq_, taup_, scratch_,
...
#define GEBRD_LAUNCHER(TYPE_A, TYPE_B, CUSOLVER_ROUTINE)                                    \
    void gebrd(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<TYPE_A> &a, \
        ...
        gebrd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, a, lda, d, e, tauq, taup, scratchpad,          \
              scratchpad_size);                                                             \
    }
...
inline void geqrf(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<T> &a,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, m, n, a_, lda, tau_, scratch_, scratchpad_size,
                                nullptr);
        });
    });
}
...
#define GEQRF_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                            \
    void geqrf(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<TYPE> &a, \
               ...
               std::int64_t scratchpad_size) {                                            \
        geqrf(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, a, lda, tau, scratchpad, scratchpad_size);   \
    }
...
template <typename Func, typename T>
void getrf(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<T> &a,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            auto scratch_ = sc.get_mem<cuDataType *>(scratch_acc);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, m, n, a_, lda, scratch_, ipiv32_, nullptr);
        });
    });
...
#define GETRF_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                     \
    void getrf(sycl::queue &queue, std::int64_t m, std::int64_t n, sycl::buffer<TYPE> &a,          \
               ...
               std::int64_t scratchpad_size) {                                                     \
        getrf(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, a, lda, ipiv, scratchpad, scratchpad_size);           \
    }
...
template <typename Func, typename T>
inline void getrs(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::transpose trans, std::int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cublas_operation(trans), n, nrhs, a_, lda,
...
#define GETRS_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                            \
    void getrs(sycl::queue &queue, oneapi::mkl::transpose trans, std::int64_t n,          \
        ...
        getrs(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, trans, n, nrhs, a, lda, ipiv, b, ldb, scratchpad,  \
              scratchpad_size);                                                           \
    }
...
inline void gesvd(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::jobsvd jobu,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cusolver_jobsvd(jobu),
...
#define GESVD_LAUNCHER(TYPE_A, TYPE_B, CUSOLVER_ROUTINE)                                           \
    void gesvd(sycl::queue &queue, oneapi::mkl::jobsvd jobu, oneapi::mkl::jobsvd jobvt,            \
               ...
               std::int64_t scratchpad_size) {                                                     \
        gesvd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt, scratchpad, \
              scratchpad_size);                                                                    \
    }
...
template <typename Func, typename T_A, typename T_B>
inline void heevd(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::job jobz, oneapi::mkl::uplo uplo,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            auto scratch_ = sc.get_mem<cuDataType_A *>(scratch_acc);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cusolver_job(jobz),
...
#define HEEVD_LAUNCHER(TYPE_A, TYPE_B, CUSOLVER_ROUTINE)                                          \
    void heevd(sycl::queue &queue, oneapi::mkl::job jobz, oneapi::mkl::uplo uplo, std::int64_t n, \
               ...
               sycl::buffer<TYPE_A> &scratchpad, std::int64_t scratchpad_size) {                  \
        heevd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, jobz, uplo, n, a, lda, w, scratchpad, scratchpad_size);    \
    }
...
template <typename Func, typename T_A, typename T_B>
inline void hegvd(const char * func_name, Func func, sycl::queue &queue, std::int64_t itype, oneapi::mkl::job jobz,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            auto scratch_ = sc.get_mem<cuDataType_A *>(scratch_acc);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cusolver_itype(itype),
...
#define HEGVD_LAUNCHER(TYPE_A, TYPE_B, CUSOLVER_ROUTINE)                                          \
    void hegvd(sycl::queue &queue, std::int64_t itype, oneapi::mkl::job jobz,                     \
               ...
               sycl::buffer<TYPE_A> &scratchpad, std::int64_t scratchpad_size) {                  \
        hegvd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, itype, jobz, uplo, n, a, lda, b, ldb, w, scratchpad,       \
              scratchpad_size);                                                                   \
    }
...
template <typename Func, typename T_A, typename T_B>
inline void hetrd(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
                  sycl::buffer<T_A> &a, std::int64_t lda, sycl::buffer<T_B> &d,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            auto scratch_ = sc.get_mem<cuDataType_A *>(scratch_acc);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cublas_fill_mode(uplo), n, a_, lda, d_, e_,
...
#define HETRD_LAUNCHER(TYPE_A, TYPE_B, CUSOLVER_ROUTINE)                                         \
    void hetrd(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,                       \
               ...
               sycl::buffer<TYPE_A> &scratchpad, std::int64_t scratchpad_size) {                 \
        hetrd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, d, e, tau, scratchpad, scratchpad_size); \
    }
...
template <typename Func, typename T>
inline void orgbr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::generate vec, std::int64_t m,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            auto scratch_ = sc.get_mem<cuDataType *>(scratch_acc);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cublas_generate(vec), m, n, k, a_, lda, tau_,
...
#define ORGBR_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                   \
    void orgbr(sycl::queue &queue, oneapi::mkl::generate vec, std::int64_t m, std::int64_t n,    \
               ...
               sycl::buffer<TYPE> &scratchpad, std::int64_t scratchpad_size) {                   \
        orgbr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, vec, m, n, k, a, lda, tau, scratchpad, scratchpad_size);  \
    }
...
template <typename Func, typename T>
inline void orgqr(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            auto scratch_ = sc.get_mem<cuDataType *>(scratch_acc);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, m, n, k, a_, lda, tau_, scratch_,
                                scratchpad_size, nullptr);
        });
    });
}
...
#define ORGQR_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                             \
    void orgqr(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,         \
               ...
               sycl::buffer<TYPE> &scratchpad, std::int64_t scratchpad_size) {             \
        orgqr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, k, a, lda, tau, scratchpad, scratchpad_size); \
    }
...
template <typename Func, typename T>
inline void orgtr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
                  sycl::buffer<T> &a, std::int64_t lda, sycl::buffer<T> &tau,
                  sycl::buffer<T> &scratchpad, std::int64_t scratchpad_size) {
    using cuDataType = typename CudaEquivalentType<T>::Type;
    overflow_check(n, lda, scratchpad_size);
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            auto scratch_ = sc.get_mem<cuDataType *>(scratch_acc);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cublas_fill_mode(uplo), n, a_, lda, tau_,
                                scratch_, scratchpad_size, nullptr);
        });
    });
}
...
#define ORGTR_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                    \
    void orgtr(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, sycl::buffer<TYPE> &a, \
               std::int64_t lda, sycl::buffer<TYPE> &tau, sycl::buffer<TYPE> &scratchpad,         \
               std::int64_t scratchpad_size) {                                                    \
        orgtr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, tau, scratchpad, scratchpad_size);        \
    }
...
template <typename Func, typename T>
inline void ormtr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::side side, oneapi::mkl::uplo uplo,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            auto scratch_ = sc.get_mem<cuDataType *>(scratch_acc);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cublas_side_mode(side),
...
#define ORMTR_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                   \
    void ormtr(sycl::queue &queue, oneapi::mkl::side side, oneapi::mkl::uplo uplo,               \
               ...
               std::int64_t scratchpad_size) {                                                   \
        ormtr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, side, uplo, trans, m, n, a, lda, tau, c, ldc, scratchpad, \
              scratchpad_size);                                                                  \
    }
...
#define ORMQR_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                     \
    void ormqr(sycl::queue &queue, oneapi::mkl::side side, oneapi::mkl::transpose trans,           \
               ...
               sycl::buffer<TYPE> &scratchpad, std::int64_t scratchpad_size) {                     \
        ormqr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, side, trans, m, n, k, a, lda, tau, c, ldc, scratchpad,      \
              scratchpad_size);                                                                    \
    }
...
template <typename Func, typename T>
inline void potrf(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            auto scratch_ = sc.get_mem<cuDataType *>(scratch_acc);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cublas_fill_mode(uplo), n, a_, lda, scratch_,
                                scratchpad_size, nullptr);
        });
    });
}
...
#define POTRF_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                    \
    void potrf(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, sycl::buffer<TYPE> &a, \
        ...
        potrf(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, scratchpad, scratchpad_size);             \
    }
...
template <typename Func, typename T>
inline void potri(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
                  sycl::buffer<T> &a, std::int64_t lda, sycl::buffer<T> &scratchpad,
                  std::int64_t scratchpad_size) {
    using cuDataType = typename CudaEquivalentType<T>::Type;
    overflow_check(n, lda, scratchpad_size);
...
#define POTRI_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                    \
    void potri(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, sycl::buffer<TYPE> &a, \
               std::int64_t lda, sycl::buffer<TYPE> &scratchpad, std::int64_t scratchpad_size) {  \
        potri(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, scratchpad, scratchpad_size);             \
    }
...
template <typename Func, typename T>
inline void potrs(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            auto b_ = sc.get_mem<cuDataType *>(b_acc);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cublas_fill_mode(uplo), n, nrhs, a_, lda, b_,
                                ldb, nullptr);
        });
    });
}
...
#define POTRS_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                   \
    void potrs(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, std::int64_t nrhs,    \
               ...
               sycl::buffer<TYPE> &scratchpad, std::int64_t scratchpad_size) {                   \
        potrs(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, nrhs, a, lda, b, ldb, scratchpad,                \
              scratchpad_size);                                                                  \
    }
...
template <typename Func, typename T>
inline void syevd(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::job jobz, oneapi::mkl::uplo uplo,
...
#define SYEVD_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                    \
    void syevd(sycl::queue &queue, oneapi::mkl::job jobz, oneapi::mkl::uplo uplo, std::int64_t n, \
               ...
               sycl::buffer<TYPE> &scratchpad, std::int64_t scratchpad_size) {                    \
        syevd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, jobz, uplo, n, a, lda, w, scratchpad, scratchpad_size);    \
    }
...
template <typename Func, typename T>
inline void sygvd(const char * func_name, Func func, sycl::queue &queue, std::int64_t itype, oneapi::mkl::job jobz,
...
#define SYGVD_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                  \
    void sygvd(sycl::queue &queue, std::int64_t itype, oneapi::mkl::job jobz,                   \
               ...
               sycl::buffer<TYPE> &scratchpad, std::int64_t scratchpad_size) {                  \
        sygvd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, itype, jobz, uplo, n, a, lda, b, ldb, w, scratchpad,     \
              scratchpad_size);                                                                 \
    }
...
template <typename Func, typename T>
inline void sytrd(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
...
#define SYTRD_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                    \
    void sytrd(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, sycl::buffer<TYPE> &a, \
               ...
               std::int64_t scratchpad_size) {                                                    \
        sytrd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, d, e, tau, scratchpad, scratchpad_size);  \
    }
...
template <typename Func, typename T>
inline void sytrf(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            auto scratch_ = sc.get_mem<cuDataType *>(scratch_acc);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cublas_fill_mode(uplo), n, a_, lda, ipiv32_,
...
#define SYTRF_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                     \
    void sytrf(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, sycl::buffer<TYPE> &a,  \
               std::int64_t lda, sycl::buffer<std::int64_t> &ipiv, sycl::buffer<TYPE> &scratchpad, \
               std::int64_t scratchpad_size) {                                                     \
        sytrf(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, ipiv, scratchpad, scratchpad_size);        \
    }
...
template <typename Func, typename T>
inline void ungbr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::generate vec, std::int64_t m,
                  std::int64_t n, std::int64_t k, sycl::buffer<T> &a, std::int64_t lda,
                  sycl::buffer<T> &tau, sycl::buffer<T> &scratchpad, std::int64_t scratchpad_size) {
    using cuDataType = typename CudaEquivalentType<T>::Type;
    overflow_check(m, n, k, lda, scratchpad_size);
...
#define UNGBR_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                   \
    void ungbr(sycl::queue &queue, oneapi::mkl::generate vec, std::int64_t m, std::int64_t n,    \
               std::int64_t k, sycl::buffer<TYPE> &a, std::int64_t lda, sycl::buffer<TYPE> &tau, \
               sycl::buffer<TYPE> &scratchpad, std::int64_t scratchpad_size) {                   \
        ungbr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, vec, m, n, k, a, lda, tau, scratchpad, scratchpad_size);  \
    }
...
template <typename Func, typename T>
inline void ungqr(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,
                  sycl::buffer<T> &a, std::int64_t lda, sycl::buffer<T> &tau,
                  sycl::buffer<T> &scratchpad, std::int64_t scratchpad_size) {
    using cuDataType = typename CudaEquivalentType<T>::Type;
    overflow_check(m, n, k, lda, scratchpad_size);
...
#define UNGQR_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                             \
    void ungqr(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k,         \
               sycl::buffer<TYPE> &a, std::int64_t lda, sycl::buffer<TYPE> &tau,           \
               sycl::buffer<TYPE> &scratchpad, std::int64_t scratchpad_size) {             \
        ungqr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, k, a, lda, tau, scratchpad, scratchpad_size); \
    }
...
template <typename Func, typename T>
inline void ungtr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
                  sycl::buffer<T> &a, std::int64_t lda, sycl::buffer<T> &tau,
                  sycl::buffer<T> &scratchpad, std::int64_t scratchpad_size) {
    using cuDataType = typename CudaEquivalentType<T>::Type;
    overflow_check(n, lda, scratchpad_size);
...
#define UNGTR_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                    \
    void ungtr(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, sycl::buffer<TYPE> &a, \
               std::int64_t lda, sycl::buffer<TYPE> &tau, sycl::buffer<TYPE> &scratchpad,         \
               std::int64_t scratchpad_size) {                                                    \
        ungtr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, tau, scratchpad, scratchpad_size);        \
    }
...
#define UNMQR_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                     \
    void unmqr(sycl::queue &queue, oneapi::mkl::side side, oneapi::mkl::transpose trans,           \
               ...
               std::int64_t lda, sycl::buffer<TYPE> &tau, sycl::buffer<TYPE> &c, std::int64_t ldc, \
               sycl::buffer<TYPE> &scratchpad, std::int64_t scratchpad_size) {                     \
        unmqr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, side, trans, m, n, k, a, lda, tau, c, ldc, scratchpad,      \
              scratchpad_size);                                                                    \
    }
...
template <typename Func, typename T>
inline void unmtr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::side side, oneapi::mkl::uplo uplo,
                  oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n, sycl::buffer<T> &a,
                  std::int64_t lda, sycl::buffer<T> &tau, sycl::buffer<T> &c, std::int64_t ldc,
                  sycl::buffer<T> &scratchpad, std::int64_t scratchpad_size) {
    using cuDataType = typename CudaEquivalentType<T>::Type;
...
#define UNMTR_LAUNCHER(TYPE, CUSOLVER_ROUTINE)                                                   \
    void unmtr(sycl::queue &queue, oneapi::mkl::side side, oneapi::mkl::uplo uplo,               \
               ...
               sycl::buffer<TYPE> &c, std::int64_t ldc, sycl::buffer<TYPE> &scratchpad,          \
               std::int64_t scratchpad_size) {                                                   \
        unmtr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, side, uplo, trans, m, n, a, lda, tau, c, ldc, scratchpad, \
              scratchpad_size);                                                                  \
    }
...
template <typename Func, typename T_A, typename T_B>
inline sycl::event gebrd(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n, T_A *a,
...
#define GEBRD_LAUNCHER_USM(TYPE_A, TYPE_B, CUSOLVER_ROUTINE)                              \
    sycl::event gebrd(sycl::queue &queue, std::int64_t m, std::int64_t n, TYPE_A *a,      \
                      ...
                      const std::vector<sycl::event> &dependencies) {                     \
        return gebrd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, a, lda, d, e, tauq, taup, scratchpad, \
...
template <typename Func, typename T>
inline sycl::event geqrf(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n, T *a,
...
#define GEQRF_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                                 \
    sycl::event geqrf(sycl::queue &queue, std::int64_t m, std::int64_t n, TYPE *a,                 \
                      ...
                      const std::vector<sycl::event> &dependencies) {                              \
        return geqrf(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, a, lda, tau, scratchpad, scratchpad_size,      \
                     dependencies);                                                                \
    }
...
template <typename Func, typename T>
inline sycl::event getrf(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n, T *a,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, m, n, a_, lda, scratch_, ipiv_, nullptr);
        });
    });
...
#define GETRF_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                             \
    sycl::event getrf(sycl::queue &queue, std::int64_t m, std::int64_t n, TYPE *a,             \
                      ...
                      std::int64_t scratchpad_size,                                            \
                      const std::vector<sycl::event> &dependencies) {                          \
        return getrf(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, a, lda, ipiv, scratchpad, scratchpad_size, \
                     dependencies);                                                            \
    }
...
// cusolverDnXgetrs does not use scratchpad memory
template <typename Func, typename T>
inline sycl::event getrs(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::transpose trans,
...
#define GETRS_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                               \
    sycl::event getrs(sycl::queue &queue, oneapi::mkl::transpose trans, std::int64_t n,          \
                      ...
                      const std::vector<sycl::event> &dependencies) {                            \
        return getrs(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, trans, n, nrhs, a, lda, ipiv, b, ldb, scratchpad,  \
                     scratchpad_size, dependencies);                                             \
    }
...
template <typename Func, typename T_A, typename T_B>
inline sycl::event gesvd(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::jobsvd jobu,
...
#define GESVD_LAUNCHER_USM(TYPE_A, TYPE_B, CUSOLVER_ROUTINE)                                   \
    sycl::event gesvd(sycl::queue &queue, oneapi::mkl::jobsvd jobu, oneapi::mkl::jobsvd jobvt, \
                      ...
                      TYPE_A *scratchpad, std::int64_t scratchpad_size,                        \
                      const std::vector<sycl::event> &dependencies) {                          \
        return gesvd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, jobu, jobvt, m, n, a, lda, s, u, ldu, vt, ldvt,  \
...
template <typename Func, typename T_A, typename T_B>
inline sycl::event heevd(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::job jobz,
...
#define HEEVD_LAUNCHER_USM(TYPE_A, TYPE_B, CUSOLVER_ROUTINE)                                      \
    sycl::event heevd(sycl::queue &queue, oneapi::mkl::job jobz, oneapi::mkl::uplo uplo,          \
                      ...
                      std::int64_t scratchpad_size,                                               \
                      const std::vector<sycl::event> &dependencies) {                             \
        return heevd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, jobz, uplo, n, a, lda, w, scratchpad,               \
                     scratchpad_size, dependencies);                                              \
    }
...
template <typename Func, typename T_A, typename T_B>
inline sycl::event hegvd(const char * func_name, Func func, sycl::queue &queue, std::int64_t itype, oneapi::mkl::job jobz,
...
#define HEGVD_LAUNCHER_USM(TYPE_A, TYPE_B, CUSOLVER_ROUTINE)                                       \
    sycl::event hegvd(sycl::queue &queue, std::int64_t itype, oneapi::mkl::job jobz,               \
                      ...
                      std::int64_t scratchpad_size,                                                \
                      const std::vector<sycl::event> &dependencies) {                              \
        return hegvd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, itype, jobz, uplo, n, a, lda, b, ldb, w, scratchpad, \
                     scratchpad_size, dependencies);                                               \
    }
...
template <typename Func, typename T_A, typename T_B>
inline sycl::event hetrd(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
...
#define HETRD_LAUNCHER_USM(TYPE_A, TYPE_B, CUSOLVER_ROUTINE)                                   \
    sycl::event hetrd(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, TYPE_A *a,   \
                      ...
                      std::int64_t scratchpad_size,                                            \
                      const std::vector<sycl::event> &dependencies) {                          \
        return hetrd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, d, e, tau, scratchpad,          \
                     scratchpad_size, dependencies);                                           \
    }
...
template <typename Func, typename T>
inline sycl::event orgbr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::generate vec, std::int64_t m,
...
#define ORGBR_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                          \
    sycl::event orgbr(sycl::queue &queue, oneapi::mkl::generate vec, std::int64_t m,        \
                      ...
                      const std::vector<sycl::event> &dependencies) {                       \
        return orgbr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, vec, m, n, k, a, lda, tau, scratchpad,        \
                     scratchpad_size, dependencies);                                        \
    }
...
template <typename Func, typename T>
inline sycl::event orgqr(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n,
...
#define ORGQR_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                                 \
    sycl::event orgqr(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k, TYPE *a, \
                      std::int64_t lda, TYPE *tau, TYPE *scratchpad, std::int64_t scratchpad_size, \
                      const std::vector<sycl::event> &dependencies) {                              \
        return orgqr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, k, a, lda, tau, scratchpad, scratchpad_size,   \
                     dependencies);                                                                \
    }
...
template <typename Func, typename T>
inline sycl::event orgtr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
...
#define ORGTR_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                                 \
    sycl::event orgtr(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, TYPE *a,         \
                      std::int64_t lda, TYPE *tau, TYPE *scratchpad, std::int64_t scratchpad_size, \
                      const std::vector<sycl::event> &dependencies) {                              \
        return orgtr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, tau, scratchpad, scratchpad_size,   \
                     dependencies);                                                                \
    }
...
template <typename Func, typename T>
inline sycl::event ormtr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::side side,
...
#define ORMTR_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                              \
    sycl::event ormtr(sycl::queue &queue, oneapi::mkl::side side, oneapi::mkl::uplo uplo,       \
                      ...
                      std::int64_t scratchpad_size,                                             \
                      const std::vector<sycl::event> &dependencies) {                           \
        return ormtr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, side, uplo, trans, m, n, a, lda, tau, c, ldc,     \
                     scratchpad, scratchpad_size, dependencies);                                \
    }
...
template <typename Func, typename T>
inline sycl::event ormqr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::side side,
                         oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
...
#define ORMQR_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                               \
    sycl::event ormqr(sycl::queue &queue, oneapi::mkl::side side, oneapi::mkl::transpose trans,  \
                      ...
                      std::int64_t scratchpad_size,                                              \
                      const std::vector<sycl::event> &dependencies) {                            \
        return ormqr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, side, trans, m, n, k, a, lda, tau, c, ldc,         \
                     scratchpad, scratchpad_size, dependencies);                                 \
    }
...
template <typename Func, typename T>
inline sycl::event potrf(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
...
#define POTRF_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                          \
    sycl::event potrf(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, TYPE *a,  \
                      ...
                      const std::vector<sycl::event> &dependencies) {                       \
        return potrf(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, scratchpad, scratchpad_size, \
                     dependencies);                                                         \
    }
...
template <typename Func, typename T>
inline sycl::event potri(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
                         T *a, std::int64_t lda, T *scratchpad, std::int64_t scratchpad_size,
                         const std::vector<sycl::event> &dependencies) {
    using cuDataType = typename CudaEquivalentType<T>::Type;
    overflow_check(n, lda, scratchpad_size);
...
#define POTRI_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                          \
    sycl::event potri(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, TYPE *a,  \
                      std::int64_t lda, TYPE *scratchpad, std::int64_t scratchpad_size,     \
                      const std::vector<sycl::event> &dependencies) {                       \
        return potri(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, scratchpad, scratchpad_size, \
                     dependencies);                                                         \
    }
...
// cusolverDnXpotrs does not use scratchpad memory
template <typename Func, typename T>
inline sycl::event potrs(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
...
#define POTRS_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                             \
    sycl::event potrs(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,              \
                      ...
                      TYPE *scratchpad, std::int64_t scratchpad_size,                          \
                      const std::vector<sycl::event> &dependencies) {                          \
        return potrs(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, nrhs, a, lda, b, ldb, scratchpad,       \
                     scratchpad_size, dependencies);                                           \
    }
...
template <typename Func, typename T>
inline sycl::event syevd(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::job jobz,
...
#define SYEVD_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                          \
    sycl::event syevd(sycl::queue &queue, oneapi::mkl::job jobz, oneapi::mkl::uplo uplo,    \
                      ...
                      std::int64_t scratchpad_size,                                         \
                      const std::vector<sycl::event> &dependencies) {                       \
        return syevd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, jobz, uplo, n, a, lda, w, scratchpad,         \
                     scratchpad_size, dependencies);                                        \
    }
...
template <typename Func, typename T>
inline sycl::event sygvd(const char * func_name, Func func, sycl::queue &queue, std::int64_t itype, oneapi::mkl::job jobz,
...
#define SYGVD_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                                 \
    sycl::event sygvd(sycl::queue &queue, std::int64_t itype, oneapi::mkl::job jobz,               \
                      ...
                      const std::vector<sycl::event> &dependencies) {                              \
        return sygvd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, itype, jobz, uplo, n, a, lda, b, ldb, w, scratchpad, \
                     scratchpad_size, dependencies);                                               \
    }
...
template <typename Func, typename T>
inline sycl::event sytrd(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
...
#define SYTRD_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                         \
    sycl::event sytrd(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, TYPE *a, \
                      ...
                      std::int64_t scratchpad_size,                                        \
                      const std::vector<sycl::event> &dependencies) {                      \
        return sytrd(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, d, e, tau, scratchpad,      \
                     scratchpad_size, dependencies);                                       \
    }
...
template <typename Func, typename T>
inline sycl::event sytrf(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
    ...
    auto done = queue.submit([&](cl::sycl::handler &cgh) {
        ...
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            ...
            auto devInfo_ = reinterpret_cast<int *>(devInfo);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cublas_fill_mode(uplo), n, a_, lda, ipiv_,
                                scratch_, scratchpad_size, devInfo_);
        });
    });
...
#define SYTRF_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                                \
    sycl::event sytrf(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, TYPE *a,        \
                      ...
                      std::int64_t scratchpad_size,                                               \
                      const std::vector<sycl::event> &dependencies) {                             \
        return sytrf(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, ipiv, scratchpad, scratchpad_size, \
                     dependencies);                                                               \
    }
...
template <typename Func, typename T>
inline sycl::event ungbr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::generate vec, std::int64_t m,
                         std::int64_t n, std::int64_t k, T *a, std::int64_t lda, T *tau,
                         T *scratchpad, std::int64_t scratchpad_size,
                         const std::vector<sycl::event> &dependencies) {
    using cuDataType = typename CudaEquivalentType<T>::Type;
...
#define UNGBR_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                          \
    sycl::event ungbr(sycl::queue &queue, oneapi::mkl::generate vec, std::int64_t m,        \
                      ...
                      TYPE *scratchpad, std::int64_t scratchpad_size,                       \
                      const std::vector<sycl::event> &dependencies) {                       \
        return ungbr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, vec, m, n, k, a, lda, tau, scratchpad,        \
                     scratchpad_size, dependencies);                                        \
    }
...
template <typename Func, typename T>
inline sycl::event ungqr(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n,
                         std::int64_t k, T *a, std::int64_t lda, T *tau, T *scratchpad,
                         std::int64_t scratchpad_size,
                         const std::vector<sycl::event> &dependencies) {
    using cuDataType = typename CudaEquivalentType<T>::Type;
...
#define UNGQR_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                                 \
    sycl::event ungqr(sycl::queue &queue, std::int64_t m, std::int64_t n, std::int64_t k, TYPE *a, \
                      std::int64_t lda, TYPE *tau, TYPE *scratchpad, std::int64_t scratchpad_size, \
                      const std::vector<sycl::event> &dependencies) {                              \
        return ungqr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, k, a, lda, tau, scratchpad, scratchpad_size,   \
                     dependencies);                                                                \
    }
...
template <typename Func, typename T>
inline sycl::event ungtr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n,
                         T *a, std::int64_t lda, T *tau, T *scratchpad,
                         std::int64_t scratchpad_size,
                         const std::vector<sycl::event> &dependencies) {
    using cuDataType = typename CudaEquivalentType<T>::Type;
...
#define UNGTR_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                                 \
    sycl::event ungtr(sycl::queue &queue, oneapi::mkl::uplo uplo, std::int64_t n, TYPE *a,         \
                      std::int64_t lda, TYPE *tau, TYPE *scratchpad, std::int64_t scratchpad_size, \
                      const std::vector<sycl::event> &dependencies) {                              \
        return ungtr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, a, lda, tau, scratchpad, scratchpad_size,   \
                     dependencies);                                                                \
    }
...
template <typename Func, typename T>
inline sycl::event unmqr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::side side,
                         oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
                         std::int64_t k, T *a, std::int64_t lda, T *tau, T *c, std::int64_t ldc,
                         T *scratchpad, std::int64_t scratchpad_size,
                         const std::vector<sycl::event> &dependencies) {
...
#define UNMQR_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                               \
    sycl::event unmqr(sycl::queue &queue, oneapi::mkl::side side, oneapi::mkl::transpose trans,  \
                      ...
                      std::int64_t scratchpad_size,                                              \
                      const std::vector<sycl::event> &dependencies) {                            \
        return unmqr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, side, trans, m, n, k, a, lda, tau, c, ldc,         \
                     scratchpad, scratchpad_size, dependencies);                                 \
    }
...
template <typename Func, typename T>
inline sycl::event unmtr(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::side side,
                         oneapi::mkl::uplo uplo, oneapi::mkl::transpose trans, std::int64_t m,
                         std::int64_t n, T *a, std::int64_t lda, T *tau, T *c, std::int64_t ldc,
                         T *scratchpad, std::int64_t scratchpad_size,
                         const std::vector<sycl::event> &dependencies) {
...
#define UNMTR_LAUNCHER_USM(TYPE, CUSOLVER_ROUTINE)                                              \
    sycl::event unmtr(sycl::queue &queue, oneapi::mkl::side side, oneapi::mkl::uplo uplo,       \
                      ...
                      std::int64_t scratchpad_size,                                             \
                      const std::vector<sycl::event> &dependencies) {                           \
        return unmtr(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, side, uplo, trans, m, n, a, lda, tau, c, ldc,     \
                     scratchpad, scratchpad_size, dependencies);                                \
    }
...
inline void gebrd_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n,
                                  std::int64_t lda, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, m, n, scratch_size);
        });
    });
}
...
#define GEBRD_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                            \
    ...
    std::int64_t gebrd_scratchpad_size<TYPE>(sycl::queue & queue, std::int64_t m, std::int64_t n, \
                                             std::int64_t lda) {                                  \
        int scratch_size;                                                                         \
        gebrd_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, lda, &scratch_size);                 \
        return scratch_size;                                                                      \
    }
...
template <typename Func>
inline void geqrf_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n,
                                  std::int64_t lda, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, m, n, nullptr, lda, scratch_size);
        });
    });
}
...
#define GEQRF_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                            \
    ...
    std::int64_t geqrf_scratchpad_size<TYPE>(sycl::queue & queue, std::int64_t m, std::int64_t n, \
                                             std::int64_t lda) {                                  \
        int scratch_size;                                                                         \
        geqrf_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, lda, &scratch_size);                 \
        return scratch_size;                                                                      \
    }
...
template <typename Func>
inline void gesvd_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::jobsvd jobu,
...
#define GESVD_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                            \
    ...
    std::int64_t gesvd_scratchpad_size<TYPE>(                                                     \
        ...
        int scratch_size;                                                                         \
        gesvd_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, jobu, jobvt, m, n, lda, ldu, ldvt,         \
                              &scratch_size);                                                     \
        return scratch_size;                                                                      \
    }
...
template <typename Func>
inline void getrf_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n,
                                  std::int64_t lda, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
...
#define GETRF_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                            \
    ...
    std::int64_t getrf_scratchpad_size<TYPE>(sycl::queue & queue, std::int64_t m, std::int64_t n, \
                                             std::int64_t lda) {                                  \
        int scratch_size;                                                                         \
        getrf_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, lda, &scratch_size);                 \
        return scratch_size;                                                                      \
    }
...
template <typename Func>
inline void heevd_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::job jobz,
...
#define HEEVD_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                     \
    ...
    std::int64_t heevd_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::job jobz,   \
                                             ...
                                             std::int64_t lda) {                           \
        int scratch_size;                                                                  \
        heevd_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, jobz, uplo, n, lda, &scratch_size); \
        return scratch_size;                                                               \
    }
...
template <typename Func>
inline void hegvd_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, std::int64_t itype,
...
#define HEGVD_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                             \
    ...
    std::int64_t hegvd_scratchpad_size<TYPE>(sycl::queue & queue, std::int64_t itype,              \
        ...
        int scratch_size;                                                                          \
        hegvd_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, itype, jobz, uplo, n, lda, ldb,             \
                              &scratch_size);                                                      \
        return scratch_size;                                                                       \
    }
...
template <typename Func>
inline void hetrd_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo,
                                  std::int64_t n, std::int64_t lda, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cublas_fill_mode(uplo), n, nullptr, lda,
...
#define HETRD_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                    \
    ...
    std::int64_t hetrd_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::uplo uplo, \
                                             std::int64_t n, std::int64_t lda) {          \
        int scratch_size;                                                                 \
        hetrd_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, lda, &scratch_size);      \
        return scratch_size;                                                              \
    }
...
template <typename Func>
inline void orgbr_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::generate vec,
    ...
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, get_cublas_generate(vec), m, n, k, nullptr, lda,
...
#define ORGBR_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                       \
    ...
    std::int64_t orgbr_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::generate vec, \
                                             ...
                                             std::int64_t lda) {                             \
        int scratch_size;                                                                    \
        orgbr_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, vec, m, n, k, lda, &scratch_size);    \
        return scratch_size;                                                                 \
    }
...
template <typename Func>
inline void orgtr_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo,
                                  std::int64_t n, std::int64_t lda, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
...
#define ORGTR_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                    \
    ...
    std::int64_t orgtr_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::uplo uplo, \
                                             std::int64_t n, std::int64_t lda) {          \
        int scratch_size;                                                                 \
        orgtr_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, lda, &scratch_size);      \
        return scratch_size;                                                              \
    }
...
template <typename Func>
inline void orgqr_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n,
                                  std::int64_t k, std::int64_t lda, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, m, n, k, nullptr, lda, nullptr, scratch_size);
        });
    });
}
...
#define ORGQR_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                            \
    ...
    std::int64_t orgqr_scratchpad_size<TYPE>(sycl::queue & queue, std::int64_t m, std::int64_t n, \
        ...
        int scratch_size;                                                                         \
        orgqr_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, k, lda, &scratch_size);              \
        return scratch_size;                                                                      \
    }
...
template <typename Func>
inline void ormqr_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::side side,
                                  oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
...
#define ORMQRF_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                            \
    ...
    std::int64_t ormqr_scratchpad_size<TYPE>(                                                      \
        ...
        int scratch_size;                                                                          \
        ormqr_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, side, trans, m, n, k, lda, ldc,             \
                              &scratch_size);                                                      \
        return scratch_size;                                                                       \
    }
...
template <typename Func>
inline void ormtr_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::side side,
...
#define ORMTR_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                             \
    ...
    std::int64_t ormtr_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::side side,          \
                                             ...
                                             std::int64_t ldc) {                                   \
        int scratch_size;                                                                          \
        ormtr_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, side, uplo, trans, m, n, lda, ldc,          \
                              &scratch_size);                                                      \
        return scratch_size;                                                                       \
    }
...
template <typename Func>
inline void potrf_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo,
                                  std::int64_t n, std::int64_t lda, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
...
#define POTRF_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                    \
    ...
    std::int64_t potrf_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::uplo uplo, \
                                             std::int64_t n, std::int64_t lda) {          \
        int scratch_size;                                                                 \
        potrf_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, lda, &scratch_size);      \
        return scratch_size;                                                              \
    }
...
template <typename Func>
inline void potri_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo,
                                  std::int64_t n, std::int64_t lda, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
...
#define POTRI_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                    \
    ...
    std::int64_t potri_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::uplo uplo, \
                                             std::int64_t n, std::int64_t lda) {          \
        int scratch_size;                                                                 \
        potri_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, lda, &scratch_size);      \
        return scratch_size;                                                              \
    }
...
template <typename Func>
inline void sytrf_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo,
                                  std::int64_t n, std::int64_t lda, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
            cusolverStatus_t err;
            CUSOLVER_ERROR_FUNC(func_name, func, err, handle, n, nullptr, lda, scratch_size);
        });
    });
}
...
#define SYTRF_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                    \
    ...
    std::int64_t sytrf_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::uplo uplo, \
                                             std::int64_t n, std::int64_t lda) {          \
        int scratch_size;                                                                 \
        sytrf_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, lda, &scratch_size);      \
        return scratch_size;                                                              \
    }
...
template <typename Func>
inline void syevd_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::job jobz,
                                  oneapi::mkl::uplo uplo, std::int64_t n, std::int64_t lda,
                                  int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
...
#define SYEVD_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                     \
    ...
    std::int64_t syevd_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::job jobz,   \
                                             ...
                                             std::int64_t lda) {                           \
        int scratch_size;                                                                  \
        syevd_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, jobz, uplo, n, lda, &scratch_size); \
        return scratch_size;                                                               \
    }
...
template <typename Func>
inline void sygvd_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, std::int64_t itype,
                                  oneapi::mkl::job jobz, oneapi::mkl::uplo uplo, std::int64_t n,
                                  std::int64_t lda, std::int64_t ldb, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
...
#define SYGVD_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                             \
    ...
    std::int64_t sygvd_scratchpad_size<TYPE>(sycl::queue & queue, std::int64_t itype,              \
                                             ...
                                             std::int64_t n, std::int64_t lda, std::int64_t ldb) { \
        int scratch_size;                                                                          \
        sygvd_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, itype, jobz, uplo, n, lda, ldb,             \
                              &scratch_size);                                                      \
        return scratch_size;                                                                       \
    }
...
template <typename Func>
inline void sytrd_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo,
                                  std::int64_t n, std::int64_t lda, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
...
#define SYTRD_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                    \
    ...
    std::int64_t sytrd_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::uplo uplo, \
                                             std::int64_t n, std::int64_t lda) {          \
        int scratch_size;                                                                 \
        sytrd_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, lda, &scratch_size);      \
        return scratch_size;                                                              \
    }
...
template <typename Func>
inline void ungbr_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::generate vec,
                                  std::int64_t m, std::int64_t n, std::int64_t k, std::int64_t lda,
                                  int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
...
#define UNGBR_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                       \
    ...
    std::int64_t ungbr_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::generate vec, \
                                             ...
                                             std::int64_t lda) {                             \
        int scratch_size;                                                                    \
        ungbr_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, vec, m, n, k, lda, &scratch_size);    \
        return scratch_size;                                                                 \
    }
...
template <typename Func>
inline void ungqr_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, std::int64_t m, std::int64_t n,
                                  std::int64_t k, std::int64_t lda, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
...
#define UNGQR_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                            \
    ...
    std::int64_t ungqr_scratchpad_size<TYPE>(sycl::queue & queue, std::int64_t m, std::int64_t n, \
                                             std::int64_t k, std::int64_t lda) {                  \
        int scratch_size;                                                                         \
        ungqr_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, m, n, k, lda, &scratch_size);              \
        return scratch_size;                                                                      \
    }
...
template <typename Func>
inline void ungtr_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::uplo uplo,
                                  std::int64_t n, std::int64_t lda, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
        onemkl_cusolver_host_task(cgh, queue, [=](CusolverScopedContextHandler &sc) {
            auto handle = sc.get_handle(queue);
...
#define UNGTR_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                    \
    ...
    std::int64_t ungtr_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::uplo uplo, \
                                             std::int64_t n, std::int64_t lda) {          \
        int scratch_size;                                                                 \
        ungtr_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, uplo, n, lda, &scratch_size);      \
        return scratch_size;                                                              \
    }
...
template <typename Func>
inline void unmqr_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::side side,
                                  oneapi::mkl::transpose trans, std::int64_t m, std::int64_t n,
                                  std::int64_t k, std::int64_t lda, std::int64_t ldc,
                                  int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
...
#define UNMQR_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                             \
    ...
    std::int64_t unmqr_scratchpad_size<TYPE>(                                                      \
        ...
        std::int64_t n, std::int64_t k, std::int64_t lda, std::int64_t ldc) {                      \
        int scratch_size;                                                                          \
        unmqr_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, side, trans, m, n, k, lda, ldc,             \
                              &scratch_size);                                                      \
        return scratch_size;                                                                       \
    }
...
template <typename Func>
inline void unmtr_scratchpad_size(const char * func_name, Func func, sycl::queue &queue, oneapi::mkl::side side,
                                  oneapi::mkl::uplo uplo, oneapi::mkl::transpose trans,
                                  std::int64_t m, std::int64_t n, std::int64_t lda,
                                  std::int64_t ldc, int *scratch_size) {
    queue.submit([&](cl::sycl::handler &cgh) {
...
#define UNMTR_LAUNCHER_SCRATCH(TYPE, CUSOLVER_ROUTINE)                                             \
    ...
    std::int64_t unmtr_scratchpad_size<TYPE>(sycl::queue & queue, oneapi::mkl::side side,          \
                                             ...
                                             std::int64_t ldc) {                                   \
        int scratch_size;                                                                          \
        unmtr_scratchpad_size(#CUSOLVER_ROUTINE, CUSOLVER_ROUTINE, queue, side, uplo, trans, m, n, lda, ldc,          \
                              &scratch_size);                                                      \
        return scratch_size;                                                                       \
    }
